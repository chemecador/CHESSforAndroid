...
public class ClientHandler extends Thread {
    ...
    public ClientHandler(ServerSocket ss, Socket cliente) {
        ...
        this.socket = cliente;
        this.ss = ss;
        // se inicializan los flujos de entrada y de salida, as√≠ como el centinela
        try {
    ...
    private void gestionarRegistro() throws IOException, SQLException {
        ...
        switch (res) {
            case -2:
            case -1:
                System.err.println("Error de conexiÛn con la base de datos");
                break;
            case 0:
    ...
    /***
     * MÈtodo que gestiona el registro en la base de datos.
     *
     * @param user Nombre de usuario
     * @param pass ContraseÒa (ya hasheada previamente)
     * @return int
     * @throws SQLException
     */
    ...
    /**
     * MÈtodo que conecta con la base de datos.
     */
    static void conectar() {
        conexion = null;
        try {
            // conexiÛn con localhost a travÈs de mi puerto
    ...
    /**
     * MÈtodo que desconecta de la base de datos
     */
